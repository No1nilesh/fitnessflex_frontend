...
function RightSidebar() {
  return (
    <>
     <div className="bg-gradient-to-b from-[#252835] to-[#273F94] w-[220px] h-[640px] rounded-lg border border-[rgba(255,255,255,0.1)] flex flex-col items-center gap-3 drop-shadow-md justify-self-end mr-3 ">
...
<ul className='flex flex-col gap-1'>
    <li className='flex  justify-center items-center gap-2 rounded-lg py-1 px-9 bg-[rgba(64,22,98,0.37)] drop-shadow-lg'>
    <img src={avatar} className="w-[35px]" alt="" />
    <div className='flex flex-col gap-0'>
        <div className='name m-0 text-white'>Anne khalifa</div> 
        <span className='time text-xs text-gray-500 m-0'>5min</span>
    </div>
    </li>
    <li className='flex  justify-center items-center gap-2   rounded-lg py-1 px-5 bg-[rgba(64,22,98,0.37)] drop-shadow-lg'>
    <img src={avatar} className="w-[35px]" alt="" />
    <div className='flex flex-col gap-0'>
        <div className='name m-0 text-white'>Anne khalifa</div> 
        <span className='time text-xs text-gray-500 m-0'>5min</span>
