...
return (
    <div className="container mx-auto py-8">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-2xl font-medium text-gray-700">Diet Plans</h2>
...

    {
      ...
      <tr className="bg-gray-100/80 border-b border-blue-300">
       <img src= {item.avatar ? item.avatar.url : Profile} alt="" className='w-8' />
        ...
        <button onClick={()=> {navigate(`/privatediets`, {state:{item}})}}  className='border border-[rgba(255,255,255,0.4)] rounded-md px-[1.5rem] py-1  bg-[#384BD6] bg-gradient-to-r from-[#384BD6] to-[#3c9ba0] drop-shadow-md hover:bg-white'>
          Add Diet
        </button>
        </th>
      </tr>
